...
export const Hero = () => {
  ...
  return (
    <section className="relative pt-5 pb-20 overflow-hidden bg-white flex items-center justify-center min-h-screen">
        ...
        <div className="relative rounded-[24px] overflow-hidden w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#06003F] via-[#1a0070] to-[#FF4E3A]">
            ...
            <motion.div
              ...
              style={{
                background: 'radial-gradient(circle, rgba(255, 78, 58, 0.6) 0%, transparent 70%)',
                filter: 'blur(80px)',
              }}
            />
            ...
            <motion.div
              ...
              style={{
                background: 'radial-gradient(circle, rgba(6, 0, 63, 0.8) 0%, transparent 70%)',
                filter: 'blur(90px)',
              }}
            />
          </div>
          ...
          <div className="relative py-32 md:py-40 flex items-center justify-center min-h-[800px]">
            <div className="w-[1000px] mx-auto px-6">
              ...
              >
                ...
                >
                  <button className="bg-[#FF4E3A] text-white px-8 py-3.5 rounded-[6px] text-sm font-semibold hover:bg-[#FF4E3A]/90 transition-all flex items-center gap-2 group shadow-xl shadow-[#FF4E3A]/20">
                    Experience it
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </button>
                  <button className="bg-white border border-white/20 text-[#06003F] px-8 py-3.5 rounded-[6px] text-sm font-semibold hover:bg-white/90 transition-all shadow-sm">
                    Schedule a Demo
                  </button>
                </motion.div>
              </motion.div>
