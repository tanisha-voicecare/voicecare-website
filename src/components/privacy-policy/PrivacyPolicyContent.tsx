...
export function PrivacyPolicyContent() {
  return (
    <div className="container mx-auto px-6 md:px-16 max-w-7xl pb-20">
      <div className="max-w-4xl mx-auto space-y-8 text-[16px] leading-relaxed">
        {/* Our Policy */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Our Policy:</h2>
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">What This Policy Covers:</h2>
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Information We Collect:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Personal Data That You Provide Through the Services:</h2>
          <p className="text-muted-foreground mb-4">
        ...
        {/* Other Information */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Other Information:</h2>
          
          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Non-Identifiable Data:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Cookies:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Aggregated Personal Data:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Log Files:</h3>
          <p className="text-muted-foreground mb-4">
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Our Use of Your Personal Data and Other Information:</h2>
          <p className="text-muted-foreground mb-4">
        ...
        {/* Our Disclosure */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Our Disclosure of Your Personal Data and Other Information:</h2>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Business Transfers:</h3>
          <p className="text-muted-foreground mb-4">
            As we develop our business, we might sell or buy businesses or assets. In the event of a corporate sale, merger, reorganization, dissolution or similar event, Personal Data may be part of the transferred assets.
          </p>

          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Related Companies:</h3>
          <p className="text-muted-foreground mb-4">
            We may also share your Personal Data with our Related Companies for purposes consistent with this Privacy Policy.
          </p>

          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Agents, Consultants and Related Third Parties:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[18px] font-semibold text-[#06003F] mb-3">Legal Requirements:</h3>
          <p className="text-muted-foreground">
        ...
        {/* Your Choices */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Your Choices:</h2>
          <p className="text-muted-foreground">
        ...
        {/* Exclusions */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Exclusions:</h2>
          <p className="text-muted-foreground">
        ...
        {/* Children */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Children:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">State Specific Consumer Privacy Rights</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Links to Other Websites:</h2>
          <p className="text-muted-foreground">
        ...
        {/* Security */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Security:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Other Terms and Conditions:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Changes to the Company&apos;s Privacy Policy:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Access to Information; Contacting Company:</h2>
          <p className="text-muted-foreground mb-4">
        ...
        {/* Retention */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Retention:</h2>
          <p className="text-muted-foreground">
        ...
        {/* Contact Us */}
        <section>
          <h2 className="text-[24px] font-bold text-[#06003F] mb-4">Contact us:</h2>
          <p className="text-muted-foreground">
