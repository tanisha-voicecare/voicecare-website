  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-16 max-w-7xl pb-12 sm:pb-16 md:pb-20">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-7 md:space-y-8 text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed">
        {/* Our Policy */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Our Policy:</h2>
          <p className="text-muted-foreground">
            Welcome to the web sites (the &quot;Site&quot; or &quot;Sites&quot;) of Voicecare Technologies, Inc. (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot; and/or &quot;our&quot;). This Site is operated by Voicecare Technologies, Inc. and has been created to provide information about our Company and our logistics and fulfillment platform, mobile applications and related products and services (together with the Sites and/or the Apps, the &quot;Services&quot;) to our Service visitors and users (&quot;you&quot;, &quot;your&quot;). This Privacy Policy sets forth the Company&apos;s policy with respect to information, including personally identifiable data (&quot;Personal Data&quot;) and other information that is collected from visitors to the Site and users of the Services.
          </p>
        </section>

        {/* What This Policy Covers */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">What This Policy Covers:</h2>
          ...
          <p className="text-muted-foreground">
            You understand and agree that the Company and its authorized business partners, affiliates, subsidiaries or agents may collect, maintain, and process information provided by you, on and through the Services. You represent and warrant that you have permission to share any information you elect to provide to Voicecare Technologies, you consent to such information being shared with third parties as described in this Privacy Policy, and that such information is accurate, current, non-misleading, and consistent and relevant for the purpose for which you are providing information.
          </p>
        </section>

        {/* Information We Collect */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Information We Collect:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Personal Data That You Provide Through the Services:</h2>
          <p className="text-muted-foreground mb-4">
          ...
          <p className="text-muted-foreground">
            By voluntarily providing us with Personal Data, you are consenting to our use of it in accordance with this Privacy Policy. If you provide Personal Data to the Services, you acknowledge and agree that (1) such Personal Data may be transferred from your current location to the offices and servers of Company and the authorized third parties referred to herein located in the United States; (2) such Personal Data may also be accessed and viewed by the authorized third parties referred to herein located out of the United States for the sole purpose of providing the Services.
          </p>
        </section>

        {/* Other Information */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Other Information:</h2>
          
          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Non-Identifiable Data:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Cookies:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Aggregated Personal Data:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Log Files:</h3>
          <p className="text-muted-foreground mb-4">
        ...
        {/* Our Disclosure */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Our Disclosure of Your Personal Data and Other Information:</h2>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Business Transfers:</h3>
          <p className="text-muted-foreground mb-4">
            As we develop our business, we might sell or buy businesses or assets. In the event of a corporate sale, merger, reorganization, dissolution or similar event, Personal Data may be part of the transferred assets.
          </p>

          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Related Companies:</h3>
          <p className="text-muted-foreground mb-4">
            We may also share your Personal Data with our Related Companies for purposes consistent with this Privacy Policy.
          </p>

          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Agents, Consultants and Related Third Parties:</h3>
          <p className="text-muted-foreground mb-4">
          ...
          <h3 className="text-[16px] sm:text-[17px] md:text-[18px] font-semibold text-[#06003F] mb-2 sm:mb-3">Legal Requirements:</h3>
          <p className="text-muted-foreground">
        ...
        {/* Your Choices */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Your Choices:</h2>
          <p className="text-muted-foreground">
            You can visit the Site without providing any Personal Data. If you choose not to provide any Personal Data, you may not be able to use certain Services. To &quot;opt-out&quot; of any consents previously given to us or receiving communications from us, send an email to{' '}
            <a href="mailto:security@voicecare.ai" className="hover:underline">
              security@voicecare.ai
            </a>
            . Notwithstanding this right to request to cease receiving communications from us, we retain the right to collect, maintain and process information provided by and collected about you on and through the Services, and disclose such information to comply with our reasonable business and legal obligations.
          </p>
        </section>

        {/* Exclusions */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Exclusions:</h2>
          <p className="text-muted-foreground">
        ...
        {/* Children */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Children:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">State Specific Consumer Privacy Rights</h2>
          <p className="text-muted-foreground">
            Certain states provide additional protections with regards to consumer privacy laws (e.g. California, Colorado, Connecticut, Utah, and Virginia). In accordance with your state&apos;s privacy laws and if applicable to our Sites and Services, you may request information on how your Personal Data is used or shared, as well as any applicable opt-outs or deletion requests. To make such a request or if you have questions about this privacy notice, please send an email to{' '}
            <a href="mailto:security@voicecare.ai" className="hover:underline">
              security@voicecare.ai
            </a>
          </p>
        ...
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Links to Other Websites:</h2>
          <p className="text-muted-foreground">
        ...
        {/* Security */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Security:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Other Terms and Conditions:</h2>
          <p className="text-muted-foreground">
            Your access to and use of the Services is subject to the Terms of Use at{' '}
            <a href="https://voicecare.ai/terms-of-use/" className="hover:underline" target="_blank" rel="noopener noreferrer">
              https://voicecare.ai/terms-of-use/
            </a>
          </p>
        </section>
        ...
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Changes to the Company&apos;s Privacy Policy:</h2>
          <p className="text-muted-foreground">
        ...
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Access to Information; Contacting Company:</h2>
          <p className="text-muted-foreground mb-4">
        ...
        {/* Retention */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Retention:</h2>
          <p className="text-muted-foreground">
        ...
        {/* Contact Us */}
        <section>
          <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#06003F] mb-3 sm:mb-4">Contact us:</h2>
          <p className="text-muted-foreground">
            If you have any questions or comments about this notice or security concerns, you may email us at{' '}
            <a href="mailto:security@voicecare.ai" className="hover:underline">
              security@voicecare.ai
            </a>
          </p>
