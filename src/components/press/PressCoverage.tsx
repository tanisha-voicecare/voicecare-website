...
export function PressCoverage({ coverageTitle = 'Recent Coverage', items }: PressCoverageProps) {
  ...
  return (
    <section className="py-12 sm:py-14 md:py-16 border-b border-[#06003F]/10">
      <div className="container mx-auto px-4 sm:px-6 md:px-16 max-w-7xl">
        <motion.div
          ...
          className="mb-10 sm:mb-11 md:mb-12"
        />
          ...
          {featuredItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <blockquote className="flex-1 mb-5 sm:mb-6 min-w-0">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3 min-w-0">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-[#FF4E3A] font-medium text-[13px] group-hover:gap-3 transition-all whitespace-nowrap shrink-0"
                  >
                    Read Article
