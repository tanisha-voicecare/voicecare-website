...
const API_CODE_LINES = [
  ...
  '',
  'response = api.call(',
  '    endpoint="/benefits/verify",',
  '    data={',
  '        "member_id": "784512963",',
  '        "service": "orthopedic_consult"',
  '    }',
  ')',
  '',
  ...
  '    "https://api.payerconnect.com/v1/benefits/verify",',
  '    json={',
  '        "member_id": "784512963",',
  ...
  '',
  'result = agent.execute("verify_benefits", member_id="784512963")',
  '',
  'log("Parsing response...")',
  'log("✔ Benefits verified successfully")'
];

const CALL_MSGS = [
  { id: 'c1', type: 'joy', text: "Hi, this is Joy calling on behalf of Silverline Hospital. I’d like to verify benefits for a patient. The member ID is 784512963." },
  { id: 'c2', type: 'payer', text: "Sure. The patient is active. There’s a $500 deductible with $200 met, 20% coinsurance, and prior authorization is required." },
  { id: 'c3', type: 'joy', text: "Thank you. Could you fax the full benefit summary to 555-123-4567?" },
  { id: 'c4', type: 'payer', text: "Absolutely, I’ll send it shortly." }
];
...
const DATA_POINTS = [
  ...
  "Status: Active",
  "Deductible: $500 total / $200 met / $300 remaining"
];

export function BenefitVerificationVisualization() {
            ...
            <div className="relative flex flex-col justify-center items-center shrink-0 w-[100px] md:w-[120px] xl:w-[160px]">
              ...
              <motion.div className="mt-2 text-center flex flex-col items-center justify-center w-[180px] xl:w-[240px] z-20 h-[40px]">
                <AnimatePresence mode="wait">
                  ...
                  {phase === 'captured' && <motion.span key="cap" initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -5 }} className="-mt-2 text-white/90 text-[14px] md:text-[16px] leading-tight font-normal font-['Satoshi']">Benefits data Successfully captured</motion.span>}
                </AnimatePresence>
              </motion.div>
            </div>
                  ...
                  >
                    ...
                    >
                      <h3 className="text-white/90 text-xl font-medium font-['Satoshi'] tracking-wide">
                        Benefits Data Captured
                      </h3>
                      <p className="text-[#FF4E3A] text-sm mt-1 uppercase tracking-widest font-medium font-['Satoshi']">
