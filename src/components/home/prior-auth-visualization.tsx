...
const API_CODE_LINES = [
  ...
  '    "https://api.payerconnect.com/v1/auth/verify",',
  '    json={',
  '        "member_id": "784512963",',
  ...
  '    print("✔ Auth requirements retrieved")',
  'else:',
  ...
  '',
  'result = agent.execute("check_auth", member_id="784512963")',
  '',
  'log("Parsing response...")',
  'log("✔ Auth rules verified successfully")'
];

const CALL_MSGS = [
  { id: 'c1', type: 'joy', text: "Hi, I’m calling to request prior authorization for a patient. Member ID is 784512963, procedure is knee arthroscopy." },
  { id: 'c2', type: 'payer', text: "Authorization is required. Please submit clinical notes. Your reference number is PA-562783." },
  { id: 'c3', type: 'joy', text: "Thanks. Could you fax the requirements to 555-123-4567?" },
...
const DATA_POINTS = [
  ...
  "Status: Pending",
  "Ref #: PA-562783",
  "Requirements: Clinical notes, MRI",
  "Fax: Requested"
];

export function PriorAuthVisualization() {
            ...
            <div className="relative flex flex-col justify-center items-center shrink-0 w-[100px] md:w-[120px] xl:w-[160px]">
              ...
              <motion.div className="mt-2 text-center flex flex-col items-center justify-center w-[180px] xl:w-[240px] z-20 h-[40px]">
                <AnimatePresence mode="wait">
                  ...
                  {phase === 'captured' && <motion.span key="cap" initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -5 }} className="-mt-2 text-white/90 text-[14px] md:text-[16px] leading-tight font-normal font-['Satoshi']">Prior Authorization Captured</motion.span>}
                </AnimatePresence>
              </motion.div>
            </div>
